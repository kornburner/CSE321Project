...
\begin{itemize}
    ...
    \item www.securityfocus.com the securityfocus websit focuses on different types of cybersecurity issue that various companies and individuals face each day.%%%%%%%%%%%%%%%%%%%% Type information about website 4 under this line %%%%%%%%%%%%%%%%%%%
    
    \item www.linuxsecurity.com%%%%%%%%%%%%%%%%%%%% Type information about website 5 under this line %%%%%%%%%%%%%%%%%%%
